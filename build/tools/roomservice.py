...
crystal_manifest = ".repo/manifests/crystal.xml"
...
def add_to_manifest(repos, fallback_branch=None):
    ...
    crystalm = load_manifest(crystal_manifest)
    ...
    for repo in repos:
        ...
        elif exists_in_tree(crystalm, repo_target) != None:
            existing_m_project = exists_in_tree(crystalm, repo_target)
